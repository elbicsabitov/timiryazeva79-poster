...
- [session_2026_07_22_rutv_fullpage_shots.md](session_2026_07_22_rutv_fullpage_shots.md) — **RU.TV fullpage-скрины light/dark** (запрос Стаса DFM 605298 «картинкой полный экран в белой и тёмной теме» → Рита коллегам): chrome-devtools file:// + `applyStyle()`, fullPage 2880×7791 PNG; «тёмная» = Glass (дефолт, что редакция видела), «белая» = Light, Apple Dark про запас (не отправлен); глаз-верификация обеих → Saved **605310/605311** документами без подписи (TG-фото ужало бы в кашу). Рельса: `.scratch/rutv4/send_fullpage_shots_to_saved.py`. Хвосты RUTV-132/MXM-002 без изменений
...
**Dashboard (для daily use) — v2.5.1 (2026-07-17, ветка `feat/rutv-showcase-v2`, HEAD `6c8343f`):**
- `designs/showcase-aggregator.html` (~184 KB) + standalone 11.0 MB; актуальная поставка = Saved msg **603106** (zip 8.40MB; 603105/602817 устарели; в DFM ушёл как 603107); 07-22 fullpage-скрины light/dark по запросу DFM 605298 = Saved **605310/605311**
