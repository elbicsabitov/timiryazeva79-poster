...
**Dashboard (для daily use) — v2.5.1 (2026-07-17, ветка `feat/rutv-showcase-v2`, HEAD `f51e60d`):**
- `designs/showcase-aggregator.html` (~184 KB) + standalone 11.0 MB; актуальная поставка = Saved msg **603106** (zip 8.40MB; 603105/602817 устарели)
