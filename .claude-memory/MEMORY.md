...
**Dashboard (для daily use) — v2.4 (2026-07-16, ветка `feat/rutv-showcase-v2`, HEAD `1e3911c`):**
- `designs/showcase-aggregator.html` (~136 KB) + standalone 10.9 MB; актуальная поставка = Saved msg **602817** (zip 8.34MB; 602743=v2.3 устарел)
- Sidebar **216px** (v2.4, правка Стаса 602802 «еще уже меню»; минимум по «Витрина подарков», nowrap, ≥1800px 224): лого розовым во ВСЕХ темах + меню Главная / Видео / Новости (табы Новости|Афиша) / Программы / Витрина подарков / Премия РУ.ТВ (кириллица, внизу, ссылка-заглушка)
- Topbar: «Прямой эфир» СЛЕВА на уровне начала hero, колокольчик убран (поиск · баллы · аватар справа)
- Главная: hero эфира + рекламный слот 300×600 (ротация) / 6 подканалов / Каналы / Новые клипы 16:9×3 / Программы / Супер 20 top-10 (+#chart) / Свежие новости (миниатюры 1:1) / Артисты / Ведущие (только имена)
- Подвал: Контакты · Редакция и реклама · Выдача призов · Приложение RU.TV (бейджи AppStore/GPlay официальные + RuStore нарисован) + рег-текст РКН + ВК/ОК/MAX + «16+» (сверка за редакцией)
- PiP мини-плеер + one-click эфир; баллы за просмотр (Twitch-механика) + витрина подарков; хедер без надписи раздела
