...
**Dashboard (для daily use) — v2.6 (2026-07-22, ветка `feat/rutv-showcase-v2`):**
- `designs/showcase-aggregator.html` (~184 KB); **v2.6.1 = стандарт ассетов Алексея (DFM 605302-305) + правильная hero-сборка: экран честный 16:9, промо-колонка ТЯНЕТСЯ к плееру (кромки бит-в-бит на любой ширине; IAB 300×600 = верхний safe-area при ≥1500px), чарт Супер 20 = видеочарт 80×45, ведущие 1:1, новости квадрат**; актуальные макеты-картинки = Saved **605346 (light) / 605347 (dark)**; последний zip = v2.5.1 Saved 603106 (в DFM 603107) — **zip v2.6 не собран**, пересобрать `tools/build_showcase_standalone.py` когда попросят файл
