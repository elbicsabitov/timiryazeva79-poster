...
**Active prototype:** `designs/twinr-liquid-glass.html` (~305 KB, 4675 строк, **22 страницы** + 5 модалок)
**Client-facing standalone:** `designs/twinr-liquid-glass-standalone.html` (**1.6 MB**, base64 backdrop inline, открывается двойным кликом без сервера)
