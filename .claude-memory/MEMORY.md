...
**Dashboard (для daily use) — v2.3 (2026-07-16, ветка `feat/rutv-showcase-v2`, все 14 правок редакции):**
- `designs/showcase-aggregator.html` (~120 KB) + standalone 10.9 MB; актуальная поставка = Saved msg 602743 (zip 8.18MB)
- Sidebar: лого розовым во ВСЕХ темах + меню Главная / Видео / Новости (табы Новости|Афиша) / Программы / Витрина подарков / Премия РУ.ТВ (кириллица, внизу, ссылка-заглушка)
