...
- `designs/showcase-aggregator.html` (~184 KB); **v2.6 = стандарт ассетов Алексея (DFM 605302-305): hero-экран честный 16:9 (промо 300×600 top-aligned), чарт Супер 20 = видеочарт 80×45, ведущие 1:1, новости квадрат**; актуальные макеты-картинки = Saved **605320 (light) / 605321 (dark)**; последний zip = v2.5.1 Saved 603106 (в DFM 603107) — **zip v2.6 не собран**, пересобрать `tools/build_showcase_standalone.py` когда попросят файл
