...
**✅ ДОСТАВЛЕНО:** zip отправлен Татьяне **msg 590167** (файлом без подписи, через серверную telethon-сессию `/opt/mama-helper` — локальная была занята JRE-аплоадом). Перед отправкой фикс по ревью Эльбика (KTV-014): «Загрузить» оживлён (файл из пикера → строка таблицы с «В Markdown» для PDF/DOCX, валидация 20 МБ), .md скачивается (имя-ссылка + кнопка «Скачать», data:text/markdown). **🔴 NEXT:** ждать фидбек Татьяны. Трекер: DEBT.md «Twinr — Хранилище… 2026-06-11» (KTV-010..014, TD-KTV-04).
