...
**🔴 ОСТАТОК (owner-фидбек — детали в HANDOFF):** (1) кнопки play/контролы на ЦЕНТРАЛЬНОЙ играющей карточке «как раньше»; (2) отступы сверху + начальное центрирование + усилить focus карусели; (3) карточки друзей «Слушать то же»→иконки ▶/＋ справа; (4) ФУЛЛ наполнить полки контентом (как онбординг); (5) убрать остатки AI с главной (панель Believer, баннер «почему?», Twinr AI, «Ты дослушал», stale-обложка); (6) поиск визуал+моб-вход; (7) моб-адаптив; (8) holistic ревью; (9) standalone; (10) реал-ассеты (лого/частота/стримы).
