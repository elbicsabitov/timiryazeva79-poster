# DEBT ARCHIVE — завершённые и легаси-треки design-project

> Вынесено из `DEBT.md` 2026-07-13: read-first файл разросся до 90 КБ и грозил
> уронить resume (флаг check-handoff.sh). Секции перенесены **дословно**, ничего не
> удалено. Открытые пункты (🔒-gate / pending) продублированы указателем в `DEBT.md` —
> ни один из них не живёт ТОЛЬКО здесь.
