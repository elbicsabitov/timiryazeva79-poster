...
| RUTV-124 | Мобильный рекламный формат: на <1100px слот 300×600 скрыт — нужен креатив 300×250 или нативный | open |
...
| RUTV-126 | Подканалы: названия/наполнение потоков подтвердить (2026-07-17: по правке 603081 на главной осталось 3 рубрики-карусели — Детям · 80-е · 2000-е; Клипы 24/7 / Без слов / Дискотека с главной убраны) | 🔒 заказчик |
| RUTV-127 | Прод-тайминги баллов: в демо ускорено ×5 (60с/90с вместо 300с/900с) — вернуть при интеграции | open |
| RUTV-128 | Мобильное меню: сайдбар на <900px скрыт, разделы недоступны (нужен burger/bottom-nav как в rutv-landing) | open |
...
| ID | Задача | Статус |
|----|--------|--------|
| RUTV-133 | Полоса брендов РМГ: лого набраны типографикой по мотивам фирменных — заменить на официальные вектора (ХИТ FM, MAXIMUM, Radio Monte Carlo, DFM, РМГ) из брендбуков при имплементации | open |
