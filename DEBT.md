...
### Showcase v2 — розовый ребрендинг + новая структура (2026-07-15, ветка `feat/rutv-showcase-v2`, commit 980f025)
...
| RUTV-126 | Подканалы: названия/наполнение потоков подтвердить (Детям · Клипы 24/7 · Без слов · Дискотека · Ретро · Хиты 2000-х — предложение) | 🔒 заказчик |
