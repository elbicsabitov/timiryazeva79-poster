...
| PST-004 | Утвердить цвет с мамой | pending |
| PST-005 | Файл для типографии (PDF 300 DPI CMYK) | pending |
| PST-006 | Уведомление через eOtinish | pending |
| PST-007 | Фото перспективы фасада | pending |
