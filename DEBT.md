...
| KTV-008 | Отправить Татьяне архивы: **twinr-zip ОТПРАВЛЕН 10.06 14:42 UTC** (msg 589650, файлом без подписи — команда Эльбика «скинь чисто архив без текста»); **CRM-zip НЕ отправлен** (драфт сообщения в session log) | twinr done · CRM 🔒 Эльбик-gate |
