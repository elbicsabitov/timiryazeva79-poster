...
| GOROD-045·047·050..057 | P1/P2/P3 остаток: Волна 3-зоны (🔒 pixel-perfect gate) · Артист/Трек deep-dive + slop-kill (🔒 нужен realign как плеер ИЛИ реал-обложки) · P2 loops (recap-карточка, контекст-старты, открытый-профиль, стрики, cold-start seed) · P3 backend (reason_tag pipeline, 🔒лицензирование CC→MERLIN, B2B taste-ads). Детали → AUDIT §8. | pending |
