...
| KTV-013 | Отправка Татьяне: zip `deliverables/2026-06-11/twinr-updates-2026-06-11.zip` (standalone 1.68 MB + twinr-brand/ + twinr-icons/) — **ЖДЁТ «гоу» Эльбика** (паттерн KTV-008: файлом без подписи) | pending |
