...
| KTV-008 | Отправка Татьяне (всё файлом без подписи, команды Эльбика): twinr-zip УШЁЛ 14:42 UTC (msg 589650) — но ДО переноса Аудио Метрики; **CRM-zip УШЁЛ 15:01 UTC (msg 589661, чистый — только standalone с кебаб-правками)**. ОСТАЛОСЬ: **re-send обновлённого twinr-zip** (`b4adcc6`: +Аудио Метрика после Статистики, +twinr-icons/) — иначе у неё нет раздела ни в одном архиве | 🔒 Эльбик-gate (re-send twinr) |
